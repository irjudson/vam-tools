# Lumina - Web/CLI Integration Summary
...
# Lumina - Multi-Catalog Feature Summary
...
- Persistent storage in `~/.lumina/catalogs.json`
...
```
~/.lumina/catalogs.json          # Persisted catalog configuration
```
