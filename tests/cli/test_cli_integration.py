...
class TestDuplicateCLI:
    ...
    def test_duplicate_cli_basic_usage(
    ...
    def test_duplicate_cli_with_threshold(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
    ...
    def test_duplicate_cli_invalid_threshold(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
    ...
    def test_duplicate_cli_no_images(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
    ...
    def test_duplicate_cli_single_image(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
...
class TestCatalogCLI:
    ...
    def test_catalog_cli_different_strategies(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
    ...
    def test_catalog_cli_conflict_resolution(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
...
class TestCLIErrorHandling:
    ...
    def test_date_cli_nonexistent_directory(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
    ...
    def test_duplicate_cli_nonexistent_directory(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
    ...
    def test_catalog_cli_nonexistent_directory(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
...
class TestCLIOutputFiles:
    ...
    def test_date_cli_creates_output_file(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
    ...
    def test_duplicate_cli_creates_output_file(
        self, cli_runner: CliRunner, temp_dir: Path
    ) -> None:
