...
from lumina.version import __version__, get_git_hash, get_version_string
...
class TestVersion:
    ...
    @patch("lumina.version.subprocess.run")
    ...
    def test_get_version_string_with_git_hash(self) -> None:
        ...
        with patch("lumina.version.get_git_hash", return_value="abc1234"):
    ...
    def test_get_version_string_without_git_hash(self) -> None:
        ...
        with patch("lumina.version.get_git_hash", return_value=None):
            result = get_version_string()
